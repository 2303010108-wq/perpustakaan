...
<html lang="en">
  ...
  <div class="container-fluid">
    <img src="assets/kudaperpus.png" alt="logo" width="120px">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
         <h2 class="fw-bold text-success"><span class="text-primary">kuda</span>perpus</h2>
          <p class="mb-4">"Temukan Dunia Pengetahuan di Ujung Jari Anda: <br> Perpustakaan Online <span class="fw-bold">yudaperpus</span> Membawa Anda ke Dunia Buku Digital."</p>
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        <div class="card-header">yuda sugara</div>
        <div class="card-body">
          <h5 class="card-title">yuda sugara</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      <div class="row">
        <div class="col">
          <img src="assets/kudaperpus.png" width="200px">
        </div>
      </div>
      <div class="row p-3">
        <div class="col mt-3">
          <h3 class="text-light fs-5">Alamat</h3>
          <p class="text-secondary fs-6">jl.margamulya, kec.cibeureum, kel.ciakar</p>
        </div>
        ...
        <div class="d-flex justify-content-center gap-4">
          ...
          <a href="https://www.instagram.com/yuda_sugara?igsh=MXhmaDFwODM5amthZw==" class="fs-3"><i class="fa-brands fa-instagram"></i></a>
        </div>
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made width ❤️ <a href="" class="text-decoration-none">yuda sugara</a>  2026</p>
        </div>
      </div>
    </footer>
