...
<style>
  ...
  <body>
      ...
      <div class="container-fluid p-3">
        ...
        <div class="dropdown">
          <button class="btn btn-light dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="../assets/kudaperpus.png" alt="memberLogo" width="40px">
          </button>
    ...
    <div class="mt-5 p-4">
      ...
      $month = date('F');
      // Mendapatkan tahun dalam format 4 digit (e.g., 2026)
      $year = date('Y');
      ?>
  ...
  <footer class="shadow-lg bg-subtle p-3">
      ...
      <p class="mt-2">Created by <span class="text-primary"> yuda sugara</span> © 2026</p>
